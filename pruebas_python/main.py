...
async def prueba_post_crear_item(recurso_id: int, ingredientes: str):
    results = {"recurso_id": recurso_id, "ingredientes": ingredientes}
...
async def prueba_get(recurso_id: int):
    results = {"recurso_id": recurso_id}
    return results
...
#connect¿¿¿???
'''
uvicorn main:app --reload para iniciar la api
